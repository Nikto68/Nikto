...
function numRetryPanel($limit = 5) {
    ...
    foreach (numAll() as $act) {
        ...
        // ⚠️ قبلا فقط سرِ تلاشِ آخر (تا ۱۴اُمی — با فاصله‌های فزاینده که
        // به ۳۶۰۰ ثانیه هم می‌رسند، یعنی گاهی چند ساعت) خبر می‌رفت. تا آن
        // موقع شماره ساعت‌ها روی فروشنده باز و هزینه‌اش در حالِ رفتن بود
